...
| Team roster | [Sports roster search board](https://www.pinterest.com/search/pins/?q=sports%20team%20roster%20dashboard%20mobile%20ui) and [selected player profile](https://www.pinterest.com/pin/1124985181967899061/) | Status distribution, meaningful filters, dense athlete rows, and an athlete review drill-down | Implemented with filter and detail interactions |
| Alerts | [Emergency and SOS UI](https://www.pinterest.com/pin/739716307569600526/) | Acknowledgement, escalation, clear next action, and documented follow-up | Implemented with response and acknowledgement flows |
...
| Session analytics | [Apple Health analytics search board](https://www.pinterest.com/search/pins/?q=apple%20health%20activity%20analytics%20mobile%20ui) and [clean fitness app](https://www.pinterest.com/pin/576390452337943140/) | Recovery trend, time range, summary, recent sessions, and condition history | Implemented with native segmented control and session drill-down |
